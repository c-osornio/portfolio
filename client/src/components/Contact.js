              ...
              <ul className="custom-list">
                <li>
                  <h6 className="font-weight-600">
                    ...
                    <span className="contact-content">+1 909 979 7464</span>
                  </h6>
                </li>
                <li>
                  <h6 className="font-weight-600">
                    ...
                    <span className="contact-content">c.alejandro.oso@gmail.com</span>
                  </h6>
                </li>
                <li>
                  <h6 className="font-weight-600">
                    ...
                    <span className="contact-content"><a href="https://www.linkedin.com/in/carlos-osornio/">carlos-osornio</a></span>
                  </h6>
                </li>
                <li>
                  <h6 className="font-weight-600">
                    ...
                    <span className="contact-content"><a href="https://github.com/c-osornio">c-osornio</a></span>
                  </h6>
                </li>
              </ul>
